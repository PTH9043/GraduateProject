#include "pch.h"
#include "Mesh.h"
CMesh::CMesh(const ComPtr<ID3D12Device>& _Device, const ComPtr<ID3D12GraphicsCommandList>& _CommandList)
{
}
CMesh::~CMesh()
{
...
void CMesh::Render(const ComPtr<ID3D12GraphicsCommandList>& _CommandList)
{
	////메쉬의 프리미티브 유형을 설정한다. 
	...
	{
		_CommandList->IASetIndexBuffer(&m_d3dIndexBufferView);
