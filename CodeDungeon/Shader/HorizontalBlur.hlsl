...
VS_OUT VS_Main(VS_IN In)
{
    ...
    //Compute_FinalMatrix(In.vPosition);
    ...
    Out.texCoord2 = In.vTexUV + float2(texelSize * -4.0f, 0.0f);
    Out.texCoord3 = In.vTexUV + float2(texelSize * -3.0f, 0.0f);
    Out.texCoord4 = In.vTexUV + float2(texelSize * -2.0f, 0.0f);
    Out.texCoord5 = In.vTexUV + float2(texelSize * -1.0f, 0.0f);
    Out.texCoord6 = In.vTexUV + float2(texelSize * 0.0f, 0.0f);
    Out.texCoord7 = In.vTexUV + float2(texelSize * 1.0f, 0.0f);
    Out.texCoord8 = In.vTexUV + float2(texelSize * 2.0f, 0.0f);
    Out.texCoord9 = In.vTexUV + float2(texelSize * 3.0f, 0.0f);
    Out.texCoord10 = In.vTexUV + float2(texelSize * 4.0f, 0.0f);
    Out.texCoord11 = In.vTexUV + float2(texelSize * 5.0f, 0.0f);
    
    //Out.texCoord1 = In.vTexUV + float2(texelSize * -0.5f, 0.0f);
    //Out.texCoord2 = In.vTexUV + float2(texelSize * -0.4f, 0.0f);
    //Out.texCoord3 = In.vTexUV + float2(texelSize * -0.3f, 0.0f);
    //Out.texCoord4 = In.vTexUV + float2(texelSize * -0.2f, 0.0f);
    //Out.texCoord5 = In.vTexUV + float2(texelSize * -0.1f, 0.0f);
    //Out.texCoord6 = In.vTexUV + float2(texelSize * 0.0f, 0.0f);
    //Out.texCoord7 = In.vTexUV + float2(texelSize * 0.1f, 0.0f);
    //Out.texCoord8 = In.vTexUV + float2(texelSize * 0.2f, 0.0f);
    //Out.texCoord9 = In.vTexUV + float2(texelSize * 0.3f, 0.0f);
    //Out.texCoord10 = In.vTexUV + float2(texelSize * 0.4f, 0.0f);
    //Out.texCoord11 = In.vTexUV + float2(texelSize * 0.5f, 0.0f);
    return Out;
}
