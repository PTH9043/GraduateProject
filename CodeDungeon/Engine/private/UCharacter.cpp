...
UCharacter::UCharacter(CSHPTRREF<UDevice> _spDevice, const _wstring& _wstrLayer, 
	...
	m_isNetworkConnected{false}, m_isPlayer{false}, m_f3CollidedNormal{}
{
}

UCharacter::UCharacter(const UCharacter& _rhs) : UPawn(_rhs), m_vPrevPos{}, m_bisHit{ false }, m_bisCollision{ false }, m_DrawOutline{ false }, m_isPlayer{ false }, m_f3CollidedNormal{}
{
}
