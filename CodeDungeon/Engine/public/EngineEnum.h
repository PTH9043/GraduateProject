...
namespace Engine {
	...
	*/
	...
	{
		// 첫 번째 그려질 것
		RI_NONALPHA_PRIORITY, RI_SHADOW,RI_NORPOS,RI_DEPTHRECORD, RI_NONALPHA_FIRST, RI_NONALPHA_LAST, RI_NONALPHA_MIDDLE, RI_ALPHA, RI_DISTORTION, RI_NOLIGHT, RI_3DUI, RI_2DUIPRIORITY, RI_2DUIMIDDLE, RI_2DUILAST, RI_TARGETS,
		RI_END
	}RENDERID;
