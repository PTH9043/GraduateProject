...
inline float Vector2::Length(const Vector2& _v)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat2(&_v);
    const XMVECTOR X = XMVector2Length(v1);
    return XMVectorGetX(X);
}
inline float Vector2::LengthSquared(const Vector2& _v)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat2(&_v);
    const XMVECTOR X = XMVector2LengthSq(v1);
...
inline float  Vector2::Dot(const Vector2& _v1, const Vector2& _v2)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat2(&_v1);
...
inline  void  Vector2::Cross(const Vector2& v1, const Vector2& v2, Vector2& result)  noexcept
{
    using namespace DirectX;
...
inline void  Vector2::Normalize(const Vector2& value, Vector2& result)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat2(&value);
    const XMVECTOR X = XMVector2Normalize(v1);
    XMStoreFloat2(&result, X);
}
inline Vector2  Vector2::NormalizeValue(const Vector2& value)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat2(&value);
    const XMVECTOR X = XMVector2Normalize(v1);
...
inline void  Vector2::Clamp(const Vector2& value, const Vector2& vmin, const Vector2& vmax, Vector2& result)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat2(&value);
    const XMVECTOR v2 = XMLoadFloat2(&vmin);
...
inline  Vector2  Vector2::Clamp(const Vector2& value, const Vector2& vmin, const Vector2& vmax)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat2(&value);
    const XMVECTOR v2 = XMLoadFloat2(&vmin);
...
inline float Vector2::Distance(const Vector2& v) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat2(this);
    const XMVECTOR x2 = XMLoadFloat2(&v);
    const XMVECTOR V = XMVectorSubtract(x2, x1);
    const XMVECTOR X = XMVector2Length(V);
    return XMVectorGetX(X);
}
inline float Vector2::DistanceSquared(const Vector2& v) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat2(this);
    const XMVECTOR x2 = XMLoadFloat2(&v);
...
inline void Vector2::Lerp(const Vector2& v1, const Vector2& v2, const float& t, Vector2& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat2(&v1);
    const XMVECTOR x2 = XMLoadFloat2(&v2);
...
inline void Vector2::Barycentric(const Vector2& v1, const Vector2& v2, const Vector2& v3, const float& f, const float& g, Vector2& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat2(&v1);
    const XMVECTOR x2 = XMLoadFloat2(&v2);
...
inline Vector2 Vector2::Barycentric(const Vector2& v1, const Vector2& v2, const Vector2& v3, const float& f, const float& g) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat2(&v1);
    const XMVECTOR x2 = XMLoadFloat2(&v2);
...
inline void Vector2::CatmullRom(const Vector2& v1, const Vector2& v2, const Vector2& v3, const Vector2& v4, const float& t, Vector2& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat2(&v1);
    const XMVECTOR x2 = XMLoadFloat2(&v2);
...
inline Vector2 Vector2::CatmullRom(const Vector2& v1, const Vector2& v2, const Vector2& v3, const Vector2& v4, const float& t) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat2(&v1);
    const XMVECTOR x2 = XMLoadFloat2(&v2);
...
inline void Vector2::Hermite(const Vector2& v1, const Vector2& t1, const Vector2& v2, const Vector2& t2, const float& t, Vector2& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat2(&v1);
...
inline Vector2 Vector2::Hermite(const Vector2& v1, const Vector2& t1, const Vector2& v2, const Vector2& t2, const float& t) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat2(&v1);
    const XMVECTOR x2 = XMLoadFloat2(&t1);
...
inline void Vector2::Refract(const Vector2& ivec, const Vector2& nvec, const float& refractionIndex, Vector2& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR i = XMLoadFloat2(&ivec);
    const XMVECTOR n = XMLoadFloat2(&nvec);
...
inline void Vector2::TransformCoord(const Vector2& v, const Matrix& m, Vector2& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat2(&v);
...
inline Vector2 Vector2::TransformCoord(const Vector2& v, const Matrix& m) noexcept
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat2(&v);
    const XMMATRIX M = XMLoadFloat4x4(&m);
...
inline void Vector2::TransformCoordStream(const Vector2* varray, size_t count, const Matrix& m, Vector2* resultArray) noexcept
{
    using namespace DirectX;
    const XMMATRIX M = XMLoadFloat4x4(&m);
...
_Use_decl_annotations_
inline void Vector2::TransformNormalStream(const Vector2* varray, size_t count, const Matrix& m, Vector2* resultArray) noexcept
{
    using namespace DirectX;
    const XMMATRIX M = XMLoadFloat4x4(&m);
...
inline void Vector2::SplineCurve(const Vector2& _prevPos, const Vector2& _vStandrardPos, const Vector2& _vNextPos1,
    const Vector2& _vNextPos2, const float& _fValue, Vector2& _result)
{
    ...
    XMVECTOR A0 = XMVectorSubtract(y3, XMVectorSubtract(y2, XMVectorAdd(y1, y1)));
    XMVECTOR A1 = XMVectorSubtract(y0, XMVectorSubtract(y1, A0));
    XMVECTOR A2 = XMVectorSubtract(y2, y0);
    XMVECTOR A3 = y1;

    float m2 = fValue * fValue;

    XMVECTOR X1 = XMVectorScale(XMVectorScale(A0, fValue), m2);
    XMVECTOR X2 = XMVectorScale(A1, m2);
    XMVECTOR X3 = XMVectorScale(A2, fValue);
    XMVECTOR X4 = A3;

    XMVECTOR R1 = XMVectorAdd(X1, X2);
    XMVECTOR R2 = XMVectorAdd(X3, X4);

    XMStoreFloat2(&_result, XMVectorAdd(R1, R2));
}
inline Vector2 Vector2::SplineCurve(const Vector2& _prevPos, const Vector2& _vStandrardPos, const Vector2& _vNextPos1,
    const Vector2& _vNextPos2, const float& _fValue)
{
    ...
    XMStoreFloat2(&value, XMVectorAdd(R1, R2));
    return value;
}

inline void Vector2::BezierCurve(const Vector2& _vStandard1, const Vector2& _vControl1, const Vector2& _vStandard2,
    const Vector2& _vControl2, const float& _fValue, Vector2& result)
{
    ...
    XMVECTOR vPos = XMVectorScale(y0, uuu);
    vPos = XMVectorAdd(vPos, XMVectorScale(y1, 3 * uu * t));
    vPos = XMVectorAdd(vPos, XMVectorScale(y2, 3 * u * tt));
    vPos = XMVectorAdd(vPos, XMVectorScale(y3, ttt));
    XMStoreFloat2(&result, vPos);
}
inline Vector2 Vector2::BezierCurve(const Vector2& _vStandard1, const Vector2& _vControl1, const Vector2& _vStandard2,
...
inline float Vector3::Length(const Vector3& _v)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat3(&_v);
    const XMVECTOR X = XMVector3Length(v1);
    return XMVectorGetX(X);
}
inline float Vector3::LengthSquared(const Vector3& _v)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat3(&_v);
    const XMVECTOR X = XMVector3LengthSq(v1);
...
inline float Vector3::Dot(const Vector3& _v1, const Vector3& _v2)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat3(&_v1);
    const XMVECTOR v2 = XMLoadFloat3(&_v2);
    const XMVECTOR X = XMVector3Dot(v1, v2);
    return XMVectorGetX(X);
}
...
inline void  Vector3::Cross(const Vector3& v1, const Vector3& v2, Vector3& result)  noexcept
{
    using namespace DirectX;
    const XMVECTOR V1 = XMLoadFloat3(&v1);
    const XMVECTOR V2 = XMLoadFloat3(&v2);
...
inline void Vector3::Normalize(const Vector3& value, Vector3& result)
{
    using namespace DirectX;
...
inline Vector3 Vector3::NormalizeValue(const Vector3& value)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat3(&value);
    const XMVECTOR X = XMVector3Normalize(v1);
...
inline  void Vector3::Clamp(const Vector3& value, const Vector3& vmin, const Vector3& vmax, Vector3& result)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat3(&value);
    const XMVECTOR v2 = XMLoadFloat3(&vmin);
...
inline  Vector3 Vector3::Clamp(const Vector3& value, const Vector3& vmin, const Vector3& vmax)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat3(&value);
    const XMVECTOR v2 = XMLoadFloat3(&vmin);
...
inline  float Vector3::Distance(const Vector3& v) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat3(this);
    const XMVECTOR x2 = XMLoadFloat3(&v);
    const XMVECTOR V = XMVectorSubtract(x2, x1);
    const XMVECTOR X = XMVector3Length(V);
    return XMVectorGetX(X);
}
inline float Vector3::DistanceSquared(const Vector3& v) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat3(this);
    const XMVECTOR x2 = XMLoadFloat3(&v);
...
inline void Vector3::Lerp(const Vector3& v1, const Vector3& v2, const float& t, Vector3& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat3(&v1);
    const XMVECTOR x2 = XMLoadFloat3(&v2);
...
inline void Vector3::Barycentric(const Vector3& v1, const Vector3& v2, const Vector3& v3, const float& f, const float& g, Vector3& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat3(&v1);
    const XMVECTOR x2 = XMLoadFloat3(&v2);
...
inline void Vector3::CatmullRom(const Vector3& v1, const Vector3& v2, const Vector3& v3, const Vector3& v4, const float& t, Vector3& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat3(&v1);
    const XMVECTOR x2 = XMLoadFloat3(&v2);
...
inline Vector3 Vector3::CatmullRom(const Vector3& v1, const Vector3& v2, const Vector3& v3, const Vector3& v4, const float& t) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat3(&v1);
    const XMVECTOR x2 = XMLoadFloat3(&v2);
...
inline void Vector3::Hermite(const Vector3& v1, const Vector3& t1, const Vector3& v2, const Vector3& t2, const float& t, Vector3& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat3(&v1);
...
inline Vector3 Vector3::Hermite(const Vector3& v1, const Vector3& t1, const Vector3& v2, const Vector3& t2, const float& t) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat3(&v1);
    const XMVECTOR x2 = XMLoadFloat3(&t1);
...
inline void Vector3::Refract(const Vector3& ivec, const Vector3& nvec, const float& refractionIndex, Vector3& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR i = XMLoadFloat3(&ivec);
    const XMVECTOR n = XMLoadFloat3(&nvec);
...
inline void Vector3::TransformCoord(const Vector3& v, const Matrix& m, Vector3& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat3(&v);
    const XMMATRIX M = XMLoadFloat4x4(&m);
...
inline Vector3 Vector3::TransformCoord(const Vector3& v, const Matrix& m) noexcept
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat3(&v);
    const XMMATRIX M = XMLoadFloat4x4(&m);
...
_Use_decl_annotations_
inline void Vector3::TransformCoordStream(const Vector3* varray, size_t count, const Matrix& m, Vector3* resultArray) noexcept
{
    using namespace DirectX;
    const XMMATRIX M = XMLoadFloat4x4(&m);
...
_Use_decl_annotations_
inline void Vector3::TransformNormalStream(const Vector3* varray, size_t count, const Matrix& m, Vector3* resultArray) noexcept
{
    using namespace DirectX;
    const XMMATRIX M = XMLoadFloat4x4(&m);
...
inline void Vector3::SplineCurve(const Vector3& _prevPos, const Vector3& _vStandrardPos, const Vector3& _vNextPos1,
    const Vector3& _vNextPos2, const float& _fValue, Vector3& _result)
{
    ...
    XMStoreFloat3(&_result, XMVectorAdd(R1, R2));
}
inline Vector3 Vector3::SplineCurve(const Vector3& _prevPos, const Vector3& _vStandrardPos, const Vector3& _vNextPos1,
    const Vector3& _vNextPos2, const float& _fValue)
{
    ...
    XMVECTOR R2 = XMVectorAdd(X3, X4);
    Vector3 value;
    XMStoreFloat3(&value, XMVectorAdd(R1, R2));
    return value;
}

inline void Vector3::BezierCurve(const Vector3& _vStandard1, const Vector3& _vControl1, const Vector3& _vStandard2,
...
inline Vector3 Vector3::BezierCurve(const Vector3& _vStandard1, const Vector3& _vControl1, const Vector3& _vStandard2,
...
inline float Vector4::Length(const Vector4& _v)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat4(&_v);
    const XMVECTOR X = XMVector4Length(v1);
    return XMVectorGetX(X);
}
inline float Vector4::LengthSquared(const Vector4& _v)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat4(&_v);
    const XMVECTOR X = XMVector4LengthSq(v1);
...
inline float Vector4::Dot(const Vector4& _v1, const Vector4& _v2)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat4(&_v1);
    const XMVECTOR v2 = XMLoadFloat4(&_v2);
    const XMVECTOR X = XMVector4Dot(v1, v2);
    return XMVectorGetX(X);
}
...
inline void Vector4::Cross(const Vector4& v1, const Vector4& v2, const Vector4& v3, Vector4& result)  noexcept
{
    using namespace DirectX;
...
inline void Vector4::Normalize(const Vector4& value, Vector4& result)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat4(&value);
    const XMVECTOR X = XMVector4Normalize(v1);
    XMStoreFloat4(&result, X);
}
inline Vector4 Vector4::NormalizeValue(const Vector4& value)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat4(&value);
    const XMVECTOR X = XMVector4Normalize(v1);
...
inline void Vector4::Clamp(const Vector4& value, const Vector4& vmin, const Vector4& vmax, Vector4& result)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat4(&value);
    const XMVECTOR v2 = XMLoadFloat4(&vmin);
...
inline Vector4 Vector4::Clamp(const Vector4& value, const Vector4& vmin, const Vector4& vmax)
{
    using namespace DirectX;
    const XMVECTOR v1 = XMLoadFloat4(&value);
    const XMVECTOR v2 = XMLoadFloat4(&vmin);
...
inline float  Vector4::Distance(const Vector4& v) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat4(this);
    const XMVECTOR x2 = XMLoadFloat4(&v);
    const XMVECTOR V = XMVectorSubtract(x2, x1);
    const XMVECTOR X = XMVector4Length(V);
    return XMVectorGetX(X);
}

inline float Vector4::DistanceSquared(const Vector4& v) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat4(this);
    const XMVECTOR x2 = XMLoadFloat4(&v);
...
inline void Vector4::Lerp(const Vector4& v1, const Vector4& v2, const float& t, Vector4& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat4(&v1);
    const XMVECTOR x2 = XMLoadFloat4(&v2);
...
inline void Vector4::Barycentric(const Vector4& v1, const Vector4& v2, const Vector4& v3, const float& f, const float& g, Vector4& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat4(&v1);
    const XMVECTOR x2 = XMLoadFloat4(&v2);
...
inline Vector4 Vector4::Barycentric(const Vector4& v1, const Vector4& v2, const Vector4& v3, const float& f, const float& g) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat4(&v1);
    const XMVECTOR x2 = XMLoadFloat4(&v2);
...
inline void Vector4::CatmullRom(const Vector4& v1, const Vector4& v2, const Vector4& v3, const Vector4& v4, const float& t, Vector4& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat4(&v1);
    const XMVECTOR x2 = XMLoadFloat4(&v2);
...
inline Vector4 Vector4::CatmullRom(const Vector4& v1, const Vector4& v2, const Vector4& v3, const Vector4& v4, const float& t) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat4(&v1);
    const XMVECTOR x2 = XMLoadFloat4(&v2);
...
inline void Vector4::Hermite(const Vector4& v1, const Vector4& t1, const Vector4& v2, const Vector4& t2, const float& t, Vector4& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat4(&v1);
...
inline Vector4 Vector4::Hermite(const Vector4& v1, const Vector4& t1, const Vector4& v2, const Vector4& t2, const float& t) noexcept
{
    using namespace DirectX;
    const XMVECTOR x1 = XMLoadFloat4(&v1);
    const XMVECTOR x2 = XMLoadFloat4(&t1);
...
inline void Vector4::Refract(const Vector4& ivec, const Vector4& nvec, const float& refractionIndex, Vector4& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR i = XMLoadFloat4(&ivec);
    const XMVECTOR n = XMLoadFloat4(&nvec);
...
inline void Vector4::SplineCurve(const Vector4& _prevPos, const Vector4& _vStandrardPos, const Vector4& _vNextPos1,
    const Vector4& _vNextPos2, const float& _fValue, Vector4& _result)
{
    ...
    XMStoreFloat4(&_result, XMVectorAdd(R1, R2));
}

inline Vector4 Vector4::SplineCurve(const Vector4& _prevPos, const Vector4& _vStandrardPos, const Vector4& _vNextPos1,
    const Vector4& _vNextPos2, const float& _fValue)
{
    ...
    XMVECTOR R2 = XMVectorAdd(X3, X4);
    Vector4 value;
    XMStoreFloat4(&value, XMVectorAdd(R1, R2));
    return value;
}

inline void Vector4::BezierCurve(const Vector4& _vStandard1, const Vector4& _vControl1, const Vector4& _vStandard2,
...
inline Vector4 Vector4::BezierCurve(const Vector4& _vStandard1, const Vector4& _vControl1, const Vector4& _vStandard2,
...
inline Matrix Matrix::CreatePerspectiveFieldOfViewRH(const float& fov, const float& aspectRatio, const float& nearPlane, const float& farPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
...
inline Matrix Matrix::CreatePerspectiveRH(const float& width, const float& height, const float& nearPlane, const float& farPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
...
inline Matrix Matrix::CreatePerspectiveOffCenterRH(const float& left, const float& right, const float& bottom, const float& top, const float& nearPlane, const float& farPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
...
inline Matrix Matrix::CreateOrthographicRH(const float& width, const float& height, const float& zNearPlane, const float& zFarPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
...
inline Matrix Matrix::CreateOrthographicOffCenterRH(const float& left, const float& right, const float& bottom, const float& top, const float& zNearPlane, const float& zFarPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
...
inline Matrix Matrix::CreatePerspectiveForRH(const float& fov, const float& aspect, const float& Near, const float& Far)
{
    using namespace DirectX;
    Matrix R;
    XMStoreFloat4x4(&R, XMMatrixPerspectiveFovRH(fov, aspect, Near, Far));
    return R;
}

inline Matrix Matrix::CreatePerspectiveFieldOfViewLH(const float& fov, const float& aspectRatio, const float& nearPlane, const float& farPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
...
inline Matrix Matrix::CreatePerspectiveLH(const float& width, const float& height, const float& nearPlane, const float& farPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
...
inline Matrix Matrix::CreatePerspectiveOffCenterLH(const float& left, const float& right, const float& bottom, const float& top, const float& nearPlane, const float& farPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
...
inline Matrix Matrix::CreateOrthographicLH(const float& width, const float& height, const float& zNearPlane, const float& zFarPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
...
inline Matrix Matrix::CreateOrthographicOffCenterLH(const float& left, const float& right, const float& bottom, const float& top, const float& zNearPlane, const float& zFarPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
...
inline Matrix Matrix::CreatePerspectiveForLH(const float& fov, const float& aspect, const float& Near, const float& Far)
{
    using namespace DirectX;
    Matrix R;
    XMStoreFloat4x4(&R, XMMatrixPerspectiveFovLH(fov, aspect, Near, Far));
    return R;
}
...
inline void Matrix::Lerp(const Matrix& M1, const Matrix& M2, const float& t, Matrix& result) noexcept
{
    using namespace DirectX;
    XMVECTOR x1 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._11));
    XMVECTOR x2 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._21));
...
inline OUTMATRIX Matrix::Get_OutMatrix() noexcept
{
    using namespace DirectX;
    OUTMATRIX OutMatrix;
    XMVECTOR vPos, vRot, vScale;
    XMMatrixDecompose(&vScale, &vRot, &vPos, XMLoadFloat4x4(this));
    XMStoreFloat3(&OutMatrix.vPos, vPos);
    XMStoreFloat3(&OutMatrix.vScale, vScale);
    XMStoreFloat4(&OutMatrix.vQuaternionRot, vRot);
    ...
    OutMatrix.vRot.x = XMConvertToDegrees(asinf(2.f * (float)(OutMatrix.vQuaternionRot.w * OutMatrix.vQuaternionRot.x -
        OutMatrix.vQuaternionRot.y * OutMatrix.vQuaternionRot.z)));
    OutMatrix.vRot.y = XMConvertToDegrees(atan2f(2.f * (float)(OutMatrix.vQuaternionRot.x * OutMatrix.vQuaternionRot.z +
        OutMatrix.vQuaternionRot.w * OutMatrix.vQuaternionRot.y), (-sqx - sqy + sqz + sqw)));
    OutMatrix.vRot.z = XMConvertToDegrees(atan2f(2.f * (float)(OutMatrix.vQuaternionRot.x * OutMatrix.vQuaternionRot.y +
        OutMatrix.vQuaternionRot.w * OutMatrix.vQuaternionRot.z), (-sqx + sqy - sqz + sqw)));

    return OutMatrix;
}
inline OUTMATRIX Matrix::Get_OutMatrix(const Matrix& _matrix) noexcept
{
    using namespace DirectX;
    OUTMATRIX OutMatrix;
    XMVECTOR vPos, vRot, vScale;
    XMMatrixDecompose(&vScale, &vRot, &vPos, XMLoadFloat4x4(&_matrix));
    XMStoreFloat3(&OutMatrix.vPos, vPos);
    XMStoreFloat3(&OutMatrix.vScale, vScale);
    XMStoreFloat4(&OutMatrix.vQuaternionRot, vRot);
    ...
    OutMatrix.vRot.x = XMConvertToDegrees(asinf(2.f * (OutMatrix.vQuaternionRot.w * OutMatrix.vQuaternionRot.x -
        OutMatrix.vQuaternionRot.y * OutMatrix.vQuaternionRot.z)));
    OutMatrix.vRot.y = XMConvertToDegrees(atan2f(2.f * (OutMatrix.vQuaternionRot.x * OutMatrix.vQuaternionRot.z +
        OutMatrix.vQuaternionRot.w * OutMatrix.vQuaternionRot.y), (-sqx - sqy + sqz + sqw)));
    OutMatrix.vRot.z = XMConvertToDegrees(atan2f(2.f * (OutMatrix.vQuaternionRot.x * OutMatrix.vQuaternionRot.y +
        OutMatrix.vQuaternionRot.w * OutMatrix.vQuaternionRot.z), (-sqx + sqy - sqz + sqw)));

    return OutMatrix;
}

inline const Vector4 DirectX::PTH::Matrix::MatrixGetFloat4(const Matrix& _Matrix, const MATRIXROW& _eMatrixRow) noexcept
{
    return *((Vector4*)&_Matrix.m[_eMatrixRow][0]);
}

inline const Vector3 DirectX::PTH::Matrix::MatrixGetFloat3(const Matrix& _Matrix, const MATRIXROW& _eMatrixRow) noexcept
{
    return *((Vector3*)&_Matrix.m[_eMatrixRow][0]);
}

inline const Matrix DirectX::PTH::Matrix::MatrixSetFloat4(const Vector4& _vSetVector, const MATRIXROW& _eMatrixRow, const Matrix& _Matrix) noexcept
{
    *((Vector4*)&_Matrix.m[_eMatrixRow][0]) = _vSetVector;
    return _Matrix;
}

inline const Matrix DirectX::PTH::Matrix::MatrixSetFloat3(const Vector3& _vSetVector, const MATRIXROW& _eMatrixRow, const Matrix& _Matrix) noexcept
{
    *((Vector3*)&_Matrix.m[_eMatrixRow][0]) = _vSetVector;
    return _Matrix;
}

inline const  Matrix Matrix::MatrixSetScaling(const Vector3& _v3Scaling, const Matrix& _Matrix) noexcept
{
    using namespace DirectX;
    ...
    vRight = XMVectorScale(XMVector3Normalize(vRight), _v3Scaling.x);
    vUp = XMVectorScale(XMVector3Normalize(vUp), _v3Scaling.y);
    vLook = XMVectorScale(XMVector3Normalize(vLook), _v3Scaling.z);
...
inline const Matrix Matrix::Combine_Matrix(const Vector3& _vScale, const Vector3& _vPos, const Quaternion& _vRotation) noexcept
{
    using namespace DirectX;
    Vector3 vScale = _vScale;
    Vector3 vPos = _vPos;
    Quaternion vRotation = _vRotation;
    XMMATRIX Rot = XMMatrixRotationQuaternion(XMLoadFloat4(&vRotation));

    Rot.r[0] = XMVectorScale(XMVector3Normalize(Rot.r[0]), vScale.x);
    Rot.r[1] = XMVectorScale(XMVector3Normalize(Rot.r[1]), vScale.y);
    Rot.r[2] = XMVectorScale(XMVector3Normalize(Rot.r[2]), vScale.z);
    Rot.r[3] = XMLoadFloat3(&vPos);

    Matrix MATRIX;
    XMStoreFloat4x4(&MATRIX, Rot);
    return MATRIX;
}
inline const Matrix Matrix::Combine_Matrix(const OUTMATRIX& _OutMatrix) noexcept
{
    using namespace DirectX;
    Vector3 vScale = _OutMatrix.vScale;
    Vector3 vPos = _OutMatrix.vPos;
    Quaternion vRotation = _OutMatrix.vQuaternionRot;
    XMMATRIX Rot = XMMatrixRotationQuaternion(XMLoadFloat4(&vRotation));
...
inline const  Matrix Matrix::MatrixSetScaling(const Vector3& _v3Scaling) noexcept
{
    return Matrix::MatrixSetScaling(_v3Scaling, *this);
}
...
{
    return Matrix::Get_Scaling(*this);
}
inline const void Matrix::Combine(const Vector3& _vScale, const Vector3& _vPos, const Quaternion& _vRotation)noexcept
{
    *this = Matrix::Combine_Matrix(_vScale, _vPos, _vRotation);
}
inline const void Matrix::Combine(const OUTMATRIX& _OutMatrix)noexcept
{
    *this = Matrix::Combine_Matrix(_OutMatrix);
}
...
inline void Quaternion::RotateTowards(const Quaternion& target, const float& maxAngle) noexcept
{
...
inline Quaternion Quaternion::CreateFromAxisAngle(const Vector3& axis, const float& angle) noexcept
{
    using namespace DirectX;
    const XMVECTOR a = XMLoadFloat3(&axis);
...
inline Quaternion Quaternion::CreateFromYawPitchRoll(const float& yaw, const float& pitch, const float& roll) noexcept
{
    using namespace DirectX;
    Quaternion R;
...
inline void Quaternion::Lerp(const Quaternion& q1, const Quaternion& q2, const float& t, Quaternion& result) noexcept
{
    using namespace DirectX;
...
inline void Quaternion::Slerp(const Quaternion& q1, const Quaternion& q2, const float& t, Quaternion& result) noexcept
{
    using namespace DirectX;
    const XMVECTOR Q0 = XMLoadFloat4(&q1);
    const XMVECTOR Q1 = XMLoadFloat4(&q2);
...
inline Quaternion Quaternion::Slerp(const Quaternion& q1, const Quaternion& q2, const float& t) noexcept
{
    using namespace DirectX;
    const XMVECTOR Q0 = XMLoadFloat4(&q1);
    const XMVECTOR Q1 = XMLoadFloat4(&q2);
