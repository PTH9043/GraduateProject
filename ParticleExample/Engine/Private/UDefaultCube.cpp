...
UDefaultCube::UDefaultCube(const UDefaultCube& _rhs) : 
	UPawn(_rhs), m_spVIBufferCube{ nullptr }, m_spNormalCubeShaderConstnatBuffer{ nullptr }
{
}
...
HRESULT UDefaultCube::NativeConstructClone(const VOIDDATAS& _vecDatas)
{
	...
	m_spVIBufferCube = static_pointer_cast<UVIBufferCube>(spGameInstance->CloneResource(PROTO_RES_VIBUFFERNORMALCUBE));
	// Add Shader 
