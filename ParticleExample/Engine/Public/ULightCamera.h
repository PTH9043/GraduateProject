#ifndef _PTH_FRAMEWORK_ENGIEN_PUBLIC_ULIGHTCAMERA_H
#define _PTH_FRAMEWORK_ENGIEN_PUBLIC_ULIGHTCAMERA_H

#include "UCamera.h"

BEGIN(Engine)

class  DEF_CACHE_ALGIN  ULightCamera : public UCamera {
public:
...
#endif // _PTH_FRAMEWORK_ENGIEN_PUBLIC_ULIGHTCAMERA_H