#ifndef _PTH_FRAMEWORK_ENGIEN_PUBLIC_USWAPCHAIN_H
#define _PTH_FRAMEWORK_ENGIEN_PUBLIC_USWAPCHAIN_H
...
class DEF_CACHE_ALGIN USwapChain final : public UBase{
public:
	USwapChain();
	NO_COPY(USwapChain)
...
#endif // _PTH_FRAMEWORK_ENGIEN_PUBLIC_USWAPCHAIN_H
