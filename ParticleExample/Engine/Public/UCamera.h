...
class ENGINE_DLL DEF_CACHE_ALGIN  UCamera abstract : public UActor {
public:
	...
	{
		tagCamDesc() : stCamProj{},	stCamValue{}, eCamType{ CAMERATYPE::OTEHR } {}
		tagCamDesc(const CAMPROJ& _stCamProj, const CAMVALUE& _stCamValue, const CAMERATYPE _eCameraType = CAMERATYPE::OTEHR)
...
#endif // _PTH_FRAMEWORK_ENGIEN_PUBLIC_UCAMERA_H
