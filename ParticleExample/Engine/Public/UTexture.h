#ifndef _PTH_FRAMEWORK_ENGIEN_PUBLIC_UTEXTURE_H
#define _PTH_FRAMEWORK_ENGIEN_PUBLIC_UTEXTURE_H
...
class ENGINE_DLL DEF_CACHE_ALGIN UTexture : public UBase  {
public:
	UTexture();
	NO_COPY(UTexture)
	DESTRUCTOR(UTexture)
...
public:
	...
	HRESULT NativeConstruct(CSHPTRREF<UDevice> _spDevice, 	const VECTOR<_wstring>& _convecPaths);
...
#endif // _PTH_FRAMEWORK_ENGIEN_PUBLIC_UTEXTURE_H
