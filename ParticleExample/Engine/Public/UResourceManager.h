#ifndef _PTH_FRAMEWORK_ENGIEN_PUBLIC_URESOURCEMANAGER_H
#define _PTH_FRAMEWORK_ENGIEN_PUBLIC_URESOURCEMANAGER_H
...
#endif // _PTH_FRAMEWORK_ENGIEN_PUBLIC_URESOURCEMANAGER_H
