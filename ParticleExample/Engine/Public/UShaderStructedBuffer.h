#ifndef _PTH_FRAMEWORK_ENGIEN_PUBLIC_USTRUCTEDBUFFER_H
#define _PTH_FRAMEWORK_ENGIEN_PUBLIC_USTRUCTEDBUFFER_H
...
class  DEF_CACHE_ALGIN UShaderStructedBuffer final : public UBase {
public:
...
public:
	...
	void PushUAVData(CSHPTRREF<UComputeTableDescriptor> _spTableDescriptor, const UAV_REGISTER& _eReg);
private:
...
#endif // _PTH_FRAMEWORK_ENGIEN_PUBLIC_USTRUCTEDBUFFER_H