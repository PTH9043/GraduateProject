...
websocketpp::lib::shared_ptr<boost::asio::ssl::context> WebSocketppClientWrapper::OnTlsInit(websocketpp::connection_hdl hdl) {
    websocketpp::lib::shared_ptr<boost::asio::ssl::context> contextPtr(new boost::asio::ssl::context(boost::asio::ssl::context::tlsv12));
    return contextPtr;
}
