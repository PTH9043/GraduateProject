#ifndef _SERVERFRAMEWORK_CORE_PUBLIC_ULUALOADER_H
#define _SERVERFRAMEWORK_CORE_PUBLIC_ULUALOADER_H
...
*/
class ULuaLoader final {
public:
	// 파일 이름만 적으면 로드가 됩니다. 
	ULuaLoader(const _string& _strFilename);
	~ULuaLoader();
public:
