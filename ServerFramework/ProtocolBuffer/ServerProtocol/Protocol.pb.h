...
inline void CS_MOVE::clear_pos() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (_impl_.pos_ != nullptr) _impl_.pos_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::POSITION& CS_MOVE::_internal_pos() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  const ::POSITION* p = _impl_.pos_;
  return p != nullptr ? *p : reinterpret_cast<const ::POSITION&>(::_POSITION_default_instance_);
}
inline const ::POSITION& CS_MOVE::pos() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:CS_MOVE.pos)
  return _internal_pos();
}
inline void CS_MOVE::unsafe_arena_set_allocated_pos(::POSITION* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.pos_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:CS_MOVE.pos)
}
inline ::POSITION* CS_MOVE::release_pos() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
...
inline ::POSITION* CS_MOVE::unsafe_arena_release_pos() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:CS_MOVE.pos)
...
inline ::POSITION* CS_MOVE::_internal_mutable_pos() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.pos_ == nullptr) {
    auto* p = CreateMaybeMessage<::POSITION>(GetArena());
...
inline ::POSITION* CS_MOVE::mutable_pos() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::POSITION* _msg = _internal_mutable_pos();
  // @@protoc_insertion_point(field_mutable:CS_MOVE.pos)
  return _msg;
}
inline void CS_MOVE::set_allocated_pos(::POSITION* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::POSITION*>(_impl_.pos_);
  ...
  _impl_.pos_ = reinterpret_cast<::POSITION*>(value);
  // @@protoc_insertion_point(field_set_allocated:CS_MOVE.pos)
}
