#ifndef _PTH_FRAMEWORK_ENGIEN_PUBLIC_UCOMPONENTMANAGER_H
#define _PTH_FRAMEWORK_ENGIEN_PUBLIC_UCOMPONENTMANAGER_H
...
#endif // _PTH_FRAMEWORK_ENGIEN_PUBLIC_UCOMPONENTMANAGER_H