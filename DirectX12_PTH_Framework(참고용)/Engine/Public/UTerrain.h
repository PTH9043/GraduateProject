...
public:
	...
	TERRAINTESSPARAM& GetTerrainTessParam() { return m_TessTerrainParam; }
public:
...
private:
	TERRAINTESSPARAM							m_TessTerrainParam;
	SHPTR<UShaderConstantBuffer>	m_spTessTerrainConstantBuffer;
	SHPTR<UVIBufferTerrain>					m_spVIBufferTerrain;
	SHPTR<UTexGroup>							m_spTextureGroup;
	 _wstring												m_wstrDiffuseTexName;
	 _wstring												m_wstrHeightTexName;

	 static constexpr _uint						TERRAINTESSPARAM_SIZE{ sizeof(TERRAINTESSPARAM) };
};
